...
export const professionalProfileSchema = z.object({
  resumeProfile: z
    .string()
    .min(10, {
      message: 'El perfil profesional debe tener al menos 10 caracteres.',
    })
    .max(1000, {
      message: 'El perfil profesional no puede exceder los 1000 caracteres.',
    }),
});
...
export const fullPersonalInfoSchem = personalInfoSchema.merge(
  z.object({ image: z.optional(imageSchema) }),
);

export const curriculumSchema = z.object({
  generalInfo: generalInfoSchema,
  personalInfo: personalInfoSchema,
  professionalProfile: z.optional(professionalProfileSchema),
