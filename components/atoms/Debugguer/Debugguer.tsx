...
export const Debugguer: React.FC<DebuggerProps> = ({ data }) => {
  ...
  return (
    <div className="fixed top-4 right-4 overflow-y-auto rounded-lg bg-black/20 outline outline-[1px] whitespace-pre-wrap outline-white/20 p-3 text-left opacity-95 backdrop-blur-sm">
